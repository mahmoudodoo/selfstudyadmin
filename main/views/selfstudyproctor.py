...
class SelfStudyProctorAPIView(View):
    ...
    def get_selfstudy_domains_registry(self):
        ...
        registries = self.SELFSYUDY_DOMAINS_REGISTRIES.copy()
        ...
        return self.SELFSYUDY_DOMAINS_REGISTRIES[0] if self.SELFSYUDY_DOMAINS_REGISTRIES else None
    ...
    def make_request_to_replica(self, method, replica_url, endpoint, data=None, timeout=10):
        ...
        try:
            ...
            print(f"Request error to {replica_url}: {str(e)}")
            return None
